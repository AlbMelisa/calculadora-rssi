...
const Calculator = (values = defaultValues) => {
  ...
  const selectedAntenna = antennas.find(
    (ant) => ant.name === selectedAntennaName
  );
  const selectedFrequency = watch("frequency") || selectedAntenna?.frequencyOne;
  ...
  const calculateRssi = (data) => {
    ...
    const antennaGainA =
      parseFloat(
        antennas.find((antenna) => antenna.name === data.antennaGainA)
          ?.antennaGain
      ) || 0;
    ...
    console.log("Antenna Gain", antennaGainA);
        ...
        <div className="row g-0 p-4">
          <div className="row g-0 color-backgraound">
            ...
            <div className="col-md-4 ps-4">
              ...
              <select className="form-select" {...register("antennaGainA")}>
                <option value="" disabled selected>
            ...
            <div className="row g-0">
              <div className="col-md-4 color-backgraound">
                ...
                <select className="form-select" {...register("antennaGainB")}>
                  ...
                  <option value={0}>Sin Antena (0dBi)</option>{" "}
                  {/* Opción adicional */}
                  {antennas.map((antenna) => (
