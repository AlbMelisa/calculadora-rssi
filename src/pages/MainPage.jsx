...
const antennas = [
  {
    ...
    description:"Conectividad de larga distancia y utiliza un patrón de antena direccional para mejorar la inmunidad del ruido.",
    frequencyOne: "5",
  ...
  },
  {
    ...
    description: "Ideal para redes inalámbricas en entornos que requieren cobertura en 360 grados en la banda de 5 GHz.",
    antennaGainOne: 13,
    frequencyOne: "5",
    image:{rssi},
    price: "$464.883"
  },
  {
    ...
    frequencyTwo:"5",
    antennaType: "Antena Direccional",
    description: "Ideal para quienes necesitan un rango confiable y una conexión estable en aplicaciones al aire libre con enfoque direccional.",
    antennaGain: 13,
    image:{rssi},
    price: "$39.950"
  }
...
const routers = [
  {
    ...
    frequencyOne: "2.4",
    frequencyTwo: "5",
    description: "Ofrece velocidades totales de hasta 1800 Mbps, con 1201 Mbps en 5 GHz y 574 Mbps en 2.4 GHz. Juega en línea, mira vídeos en 4K y maximiza todo al máximo sin retrasos.",
    internalAntennas: 0,
    externalAntennas: 4,
    price: "$62.041",
    powerOne: 30,
  ...
  },
  {
    ...
    frequencyOne: "2.4",
    frequencyTwo: "5",
    description: "Disfrute de funciones de seguridad avanzadas que brindan un entorno seguro que protege los datos y de la red.",
    internalAntennas: 0,
    externalAntennas: 4,
    price: "$129.990",
    powerOne: 20,
  ...
  },
  {
    ...
    frequencyOne: "2.4",
    description: "Brinda a los dispositivos la capacidad de acceder a Internet donde y cuando sea que se encuentre el usuario.",
    internalAntennas: 4,
    externalAntennas: 0,
    price: "$64.890",
    powerOne: 20,
  ...
  return (
    <div>
      ...
      <div className="row g-0">
        ...
        <h5 className="d-flex text-center justify-content-center p-3 m-0 color-back text-white">
          Obtenga información sobre los equipos y antenas para luego poder calcular el RSSI.
        </h5>{" "}
      </div>
      <div id="equipment">
        ...
        <h5 className="text-center p-1 ">
          En esta sección usted podra ver la información sobre los equipos
          disponibles
        </h5>
      </div>
      <div className="row g-0">
      ...
      <div className="row g-0">
        <h5 className="text-center p-1 ">
          En esta sección usted podra ver la información sobre las antenas
          disponibles
        </h5>
      ...
      <span id="calculator"></span>
        <h2 className="d-flex text-center justify-content-center p-3 " id="calculator">
